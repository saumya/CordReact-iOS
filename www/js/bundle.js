...
/***/ function(module, exports, __webpack_require__) {
	...
	var SeeAllControllerView = React.createClass({
	  displayName: 'SeeAllControllerView',

	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      'SeeAllControllerView'
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var AddNewControllerView = React.createClass({
	  displayName: 'AddNewControllerView',

	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      'AddNewControllerView'
	    );
	  }
	});
	module.exports = AddNewControllerView;
